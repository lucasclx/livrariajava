 ...
 * Em produção, use uma biblioteca robusta como BCrypt ou Argon2.
 */
public class PasswordUtil {
    
    /**
     * Gera hash da senha (implementação simplificada).
     * ATENÇÃO: Em produção, use BCrypt.hashpw(plainPassword, BCrypt.gensalt()).
     */
     ...
     * ATENÇÃO: Em produção, use BCrypt.checkpw(plainPassword, hashedPassword).
     */
